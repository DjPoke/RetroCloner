...
bonus_types = {
	{name = "points", bonus = 10, idle = 0, collision_box_x = 1, collision_box_y = 1},
	{name = "life", bonus = 1, idle = 0, collision_box_x = 1, collision_box_y = 1},
	{name = "health", bonus = 20, idle = 0, collision_box_x = 1, collision_box_y = 1},
	{name = "invincible", duration = 10, idle = 0, collision_box_x = 1, collision_box_y = 1}
}

bonus_animations = {
	{"bonus", "idle", "collision_box_x", "collision_box_y"},
	{"bonus", "idle", "collision_box_x", "collision_box_y"},
	{"bonus", "idle", "collision_box_x", "collision_box_y"},
	{"duration", "idle", "collision_box_x", "collision_box_y"}
}
